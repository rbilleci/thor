...
Return the exact structured Blueprint only to the invoking Slice Owner through the trusted platform result channel. Do not write a temporary artifact, send the Blueprint to the Dispatcher, or expose an artifact reference or digest. Return only:
