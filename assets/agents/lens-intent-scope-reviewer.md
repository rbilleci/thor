...
Put every supported result-changing interpretation that requires authority in `Findings` as `AUTHORITY_REQUIRED` and every authorized discrepancy as `REPAIR`.
